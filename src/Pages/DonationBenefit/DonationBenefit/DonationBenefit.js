    ...
    return (
        <div className='container my-5'>
            ...
            <div className="row justify-content-center gy-5">
                <div className="col-10 col-lg-10 box-shadow rounded p-5 benefit-box">
                    <div className="row justify-content-around align-items-center gy-3">
                ...
                <div className="col-10 col-lg-10  box-shadow rounded p-5 benefit-box">
                    <div className="row justify-content-around align-items-center gy-3">
                        <div className="col-12 col-lg-5 order-2 text-center text-lg-start">
